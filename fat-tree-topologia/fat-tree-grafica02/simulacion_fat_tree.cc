...
int main (int argc, char *argv [])
{
  ...
  std::ofstream fichero ("prueba2-fattree.plt");
...
{
  Gnuplot grafica;
  grafica.SetTitle ("Prueba 2 - Fat-Tree: Tiempo para que se cargue un 10% de un video de 5 minutos frente a la tasa del canal");
