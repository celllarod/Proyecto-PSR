...
NS_LOG_COMPONENT_DEFINE ("Bcube_inicial");
...
int main(int argc, char *argv[]){
  ...
  uint32_t maxPaquetes = 11579;
  DataRate bitrate_p2p ("10Gbps");
  DataRate bitrate_csma ("300Mbps");
  ...
  escenario (tamPaquete, intervalo, maxPaquetes, retardo_canal_p2p, retardo_canal_csma, bitrate_p2p, bitrate_csma);
...
ObservadorPaquetes escenario(uint32_t tamPaquete, Time intervalo, uint32_t maxPaquetes, Time delay_p2p, Time delay_csma, DataRate bitrate_p2p, DataRate bitrate_csma){
    ...
    mobility.Install(pc1);
    mobility.Install(pc2);
    mobility.Install(pc3);
    mobility.Install(pc4);
    mobility.Install(pc5);
    mobility.Install(pc6);
    mobility.Install(pc7);
    mobility.Install(pc8);
    mobility.Install(pc9);
    mobility.Install(pc10);
    mobility.Install(pc11);
    mobility.Install(pc12);
    mobility.Install(pc13);
    mobility.Install(pc14);
    mobility.Install(pc15);
    mobility.Install(pc16);
    ...
    mobility2.SetPositionAllocator ("ns3::GridPositionAllocator",
                                    ...
                                    "LayoutType", StringValue ("RowFirst"));
    mobility2.Install(sw01);
    mobility2.Install(sw02);
    mobility2.Install(sw03);
    mobility2.Install(sw04);
    ...
    mobility3.SetPositionAllocator ("ns3::GridPositionAllocator",
                                    ...
                                    "GridWidth", UintegerValue (4),
                                    "LayoutType", StringValue ("RowFirst"));
    mobility2.Install(sw11);
    mobility2.Install(sw12);
    mobility2.Install(sw13);
    mobility2.Install(sw14);
    mobility2.Install(pcClient1);

  AnimationInterface anim ("bcube_anim.xml");
