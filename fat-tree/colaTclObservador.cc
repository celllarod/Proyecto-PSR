...
ColaTclObservador::ColaTclObservador (Ptr<QueueDisc> cola_tcl )
{
  ...
  cola_tcl->TraceConnectWithoutContext ("Enqueue",
                                        MakeCallback(&ColaTclObservador::EncolaPq,
                                                     this));    
  cola_tcl->TraceConnectWithoutContext ("Dequeue",
                                        MakeCallback(&ColaTclObservador::DesencolaPq,
                                                     this));  
  cola_tcl->TraceConnectWithoutContext ("Drop",
                                        MakeCallback(&ColaTclObservador::EliminaPq,
                                                     this)); 
  
 /*  cola_tcl->TraceConnectWithoutContext ("PacketsInQueue",
                                        MakeCallback(&ColaTclObservador::CambiaCola,
                                                     this));   
                                               */
}
